...
extern "C" jint
Java_com_transferCL_TransferCLlib_training(JNIEnv* env,
                                            jclass clazz,
...
extern "C" jint
Java_com_transferCL_TransferCLlib_prediction(JNIEnv* env,
                                              jclass clazz,
                                              jstring appDirectory,
                                              jstring cmdPrediction) {
...
extern "C" jint
Java_com_transferCL_TransferCLlib_prepareFiles(JNIEnv* env,
                                                jclass clazz,
                                                jstring appDirectory,
                                                jstring fileNameStoreData,
                                                jstring fileNameStoreLabel,
                                                jstring fileNameStoreNormalization,
	...
	// LOGI((*env)->NewStringUTF(env, stringManifestPath));
	string path2=path+"directoryTest/";
	...
	t->prepareFiles(stringManifestPath,
                    nbImage,
                    imagesChannelNb,
                    stringFileNameStoreData,
                    stringFileNameStoreLabel,
                    stringFileNameStoreNormalization);

...
public:
    ...
    CLKernel *buildKernelFromString(std::string operation,std::string source, std::string kernelname, std::string options, std::string sourcefilename = "");

...
//   LOGI( "Reading %s", filename.c_str());
   ...
   for(int row = 0; row < height; row++) {
           for(int col = 0; col < width; col++) {
               for(int plane = 0; plane < planes; plane++) {
            	   values[plane*width*height + row*width + col] = rgb_image[row*width*planes + col*planes + plane];
               }
           }
       }
...
///////////////////////////
//
//    unsigned char *image_buffer2 = new unsigned char[width * height * planes];
//
...
//        row_pointer[0] = & image_buffer2[cinfo.output_scanline * row_stride];
...
////        for(int col = 0; col < width; col++) {
////            for(int plane = 0; plane < planes; plane++) {
////            	values[plane*width*height + row*width + col] = image_buffer2[row*width*planes + col*planes + plane];
////            }
////        }
////    }
//
...
//            for(int col = 0; col < width; col++) {
//                for(int plane = 0; plane < planes; plane++) {
//                    if( value2[row*width*planes + col*planes + plane]!= values[row*width*planes + col*planes + plane])
//                    	LOGI("true[%d]=%d Val2[%d]=%d",row*width*planes + col*planes + plane, values[row*width*planes + col*planes + plane],row*width*planes + col*planes + plane,value2[row*width*planes + col*planes + plane]);
//                }
//            }
//        }
//

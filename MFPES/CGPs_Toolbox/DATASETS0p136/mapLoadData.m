...
% 	mapLoadData.m SVN version 341
% 	last update 2009-05-07T07:07:31.798627Z
...
%     missingData{1} = 60:140;
%     missingData{2} = 60:140;
%     missingData{3} = 60:140;
%     missingData{4} = 60:140;
%     
    missingData{1} = 101:160;
%     missingData{2} = 101:160;
%     missingData{3} = 21:90;
    missingData{4} = 21:90;
    ntrainx =200;

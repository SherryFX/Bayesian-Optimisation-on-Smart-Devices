...
%	
%
%	DATA = LOADFXDATA(DATASETNAME) Loads the desired data set for the FX
%	data from a .txt file and returns all the relevant data stored in a
%	structure.
%	 Returns:
%	  DATA - Structure with all the relevant FX data.
%	 Arguments:
%	  DATASETNAME - The data set to load.
%	
%
%	See also
%	DEMSIMDTCFXDATA, DEMSIMWHITEDTCFXDATA, FXDATARESULTS


%	Copyright (c) 2009 David Luengo
% 	loadFxData.m SVN version 402
% 	last update 2009-06-10T21:06:54.000000Z

...
%	Description:
%
%	SIMWHITEMEANCREATE creates the mean function for a multi output GP
%	model based in the SIM-WHITE kernel (first order differential
%	equation with white noise input process). The outputs of the model
...
% 	simwhiteMeanCreate.m SVN version 289

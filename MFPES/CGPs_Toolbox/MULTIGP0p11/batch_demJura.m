...
%
%	Description:
%	[total_t, maerror] = batch_demJura(options, data, ntrainX, ntrainX2, approx, missingData, iters)
%% 	batch_demJura.m SVN version 131
% 	last update 2008-10-29T09:13:29.000000Z
% Setup model

...
%
%	See also
%	DEMSIMWHITEDTCFXDATA, LOADFXDATA, FXDATARESULTS


%	Copyright (c) 2009 David Luengo
% 	demSimDtcFxData.m SVN version 394
...
model.comp{1}.X_u = linspace(count(1), count(end), model.comp{1}.k)';
...
save([baseDirResults 'demSimDtc' capName 'Exp' num2str(experimentNo) '.mat'], ...
    'model', 'missingData', 'meanVal', 'scaleVal', 'trainingTime');

if optionDisplayResults == true
    [rmse, nmse] = fxDataResults(dataSetName, model.comp{1}.kernType, model.comp{1}.approx, ...
        experimentNo, [], [optionPlotFigures optionSaveFigures optionShowError]);
end

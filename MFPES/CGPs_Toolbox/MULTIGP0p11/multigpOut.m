...
%	Description:
%
%	Y = MULTIGPOUT(MODEL, X) evaluates the outputs of a multigp Gaussian
%	process model for a set of inputs x
%	 Returns:
%	  Y - the output of the MULTIGP model.
%	 Arguments:
%	  MODEL - the model for which the output is being evaluated.
%	  X - the input position for which the output is required.
%
%	Y = MULTIGPOUT(MODEL, X, F) evaluates the outputs of a multigp
%	Gaussian process model for a set of inputs x and values of latent
%	functions given
%	 Returns:
%	  Y - the output of the MULTIGP model.
%	 Arguments:
%	  MODEL - the model for which the output is being evaluated.
%	  X - the input position for which the output is required.
%	  F - latent function value for which the output is required.
%	
%
%	See also
%	MULTIGPCREATE, MULTIGPPOSTERIORMEANVAR


%	Copyright (c) 2009 Mauricio Alvarez
% 	multigpOut.m SVN version 332
% 	last update 2009-04-21T18:27:40.000000Z
